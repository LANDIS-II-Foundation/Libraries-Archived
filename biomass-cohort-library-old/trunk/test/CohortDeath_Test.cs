...
namespace Landis.Test.Biomass
{
    ...
    public class CohortDeath_Test
    {
        ...
        public class RemoveAgeBetween5And30_AgeOnly
            : RemoveAgeBetween5And30,
              Landis.AgeCohort.ICohortDisturbance
        {
            ...
            bool Landis.AgeCohort.ICohortDisturbance.Damage(Landis.AgeCohort.ICohort cohort)
            {
                if (5 <= cohort.Age && cohort.Age <= 30)
                    return true;
                else
        ...
        private void CohortsRemoved(object disturbance)
        {
            ...
            else if (disturbance is Landis.AgeCohort.ICohortDisturbance)
                ((Landis.AgeCohort.ISiteCohorts) cohorts).DamageBy((Landis.AgeCohort.ICohortDisturbance) disturbance);
