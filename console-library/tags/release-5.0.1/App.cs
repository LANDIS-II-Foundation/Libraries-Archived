	...
	public static class App
	{
		public static int Main(string[] args)
		{
			try {
				...
				string release = "official";  //AssemblyInfo.GetRelease(assembly);
				if (release == "official")
					release = "";
				...
				UI.WriteLine("Landis-II {0}.{1} Service Pack 1{2}", version.Major, version.Minor, release);
				UI.WriteLine("Copyright 2004-2006 University of Wisconsin");
				UI.WriteLine();
