...
namespace Landis.Library.BiomassCohortsPnET
{
    public class SiteCohorts
        : ISiteCohorts, AgeOnlyCohorts.ISiteCohorts, BiomassCohorts.ISiteCohorts
    {
      ...
      //   private Landis.Library.Biomass.Species.AuxParm<int> establishments;
       ...
       //     }
        ...
        {
            foreach (Landis.Library.BiomassCohortsPnET.SpeciesCohorts speciesCohorts in cohorts)
                yield return speciesCohorts;
        }
