...
namespace Landis.Library.BiomassCohortsPnET
{
    public class OutputHeaders
    {
        ...
        public const string Tday = "Tday";  
        public const string Precip = "Precip";  
        public const string RunOff = "RunOff";
        public const string SurfaceRunOff = "SurfaceRunOff"; 
        ...
        public const string NSCfrac = "NSCfrac(g_mm)";            
        public const string fWater = "fWater(g_mm)";
