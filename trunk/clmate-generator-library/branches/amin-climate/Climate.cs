    ...
    public class Climate
    {
        ...
        public static void GenerateClimate_GetPDSI(int startYear, int endYear)
        {
            ...
            foreach (IEcoregion ecoregion in Climate.ModelCore.Ecoregions)
            {
                ...
                {
                    acs[i - startYear] = new AnnualClimate_Monthly(ecoregion, 0, Landis.Extension.Succession.Century.EcoregionData.Latitude[ecoregion]); // Latitude should be given
                ...
                if (ecoregion.Active)
                {
                    if (true)//(ecoregion.Index == 0)
                    {
                        ...
                        foreach (KeyValuePair<int, IClimateRecord[,]> timeStep in future_allData)
                        {
                            if (timeStep.Key != 0)
                            {
                                acs[timestepIndex] = new AnnualClimate_Monthly(ecoregion, startYear + timeStep.Key, Landis.Extension.Succession.Century.EcoregionData.Latitude[ecoregion], climatePhase, timeStep.Key); // Latitude should be given
                                timestepIndex++;
                            }
                        }
                        double AWC = Landis.Extension.Succession.Century.EcoregionData.FieldCapacity[ecoregion] - Landis.Extension.Succession.Century.EcoregionData.WiltingPoint[ecoregion];
        ...
        public static void GetPDSI_Test()
        {
            ...
            if (endYear > startYear)
            {
                ...
                //for (int i = startYear; i <= endYear; i++)
                //{
                //    acs[i - startYear] = new AnnualClimate_Monthly(ecoregion, i, 0); // Latitude should be given
                //    //Console.WriteLine(ac.MonthlyTemp[0].ToString() + "\n");
                //    //Console.WriteLine(ac.MonthlyPrecip[0].ToString() + "\n");
                //}
        ...
        //                    if (field.ToLower().Contains("tmax") || field.ToLower().Contains("tmin"))
        //                    {
        //                        //CurrentScenarioName = field.Substring(1, field.LastIndexOf("t") - 2);
        //                        if (field.ToLower().Contains("tmax"))
        //                            CurrentScenarioType = "tmax";
        //                        if (field.ToLower().Contains("tmin"))
        //                            CurrentScenarioType = "tmin";
        //                    }
        //                    if (field.ToLower().Contains("pr"))
        //                    {
        ...
        //                    }
        //                }
        //                else if (CurrentScenarioType.Contains("min"))
        //                {
        //                    IndexMin_MeanT = 3;
        //                    //IndexMin_MaxT = 5;
        //                    IndexMin_Var = 4;
        ...
        //                    }
        //                }
        //                else if (CurrentScenarioType.Contains("pr"))
        //                {
        //                    IndexPrcp_MeanT = 6;
        //                    //IndexPrcp_MaxT = 9;
        //                    IndexPrcp_Var = 7;
        ...
        //                {
        //                    //tempScenarioName = CurrentScenarioName;
        //                    if (field.ToLower().Contains("ppt"))
        //                    {
        //                        //CurrentScenarioName = field.Substring(1, 4);
        //                        CurrentScenarioType = "ppt";

        //                    }

        //                    else if (field.ToLower().Contains("tmx") || field.Contains("tmn"))
        //                    {
        //                        //CurrentScenarioName = field.Substring(1, 4);
        //                        if (field.ToLower().Contains("tmx"))
        //                            CurrentScenarioType = "tmx";
        //                        if (field.ToLower().Contains("tmn"))
        //                            CurrentScenarioType = "tmn";
        //                    }
        ...
        //                key = fields[0].ToString();
        //                if (CurrentScenarioType.Contains("ppt"))
        //                {
        //                    IndexPrcp_MeanT = 6;
        //                    //IndexPrcp_MaxT = 9;
        //                    IndexPrcp_Var = 7;
        ...
        //                else if (CurrentScenarioType.Contains("tmx"))
        //                {
        //                    IndexMax_MeanT = 0;
        //                    //IndexMax_MaxT = 1;
        //                    IndexMax_Var = 1;
        ...
        //                    }
        //                }
        //                else if (CurrentScenarioType.Contains("tmn"))
        //                {
        //                    IndexMin_MeanT = 3;
        //                    //IndexMin_MaxT = 5;
        //                    IndexMin_Var = 4;
