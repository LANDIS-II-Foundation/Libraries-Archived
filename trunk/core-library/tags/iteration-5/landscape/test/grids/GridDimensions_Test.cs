...
namespace Landis.Test
{
	...
	public class GridDimensions_Test
	{
		...
		{
			Assert.AreEqual("0 rows, 0 columns", dims.ToString());
			Assert.AreEqual("4321 rows, 789 columns",
			                dims_4321_789.ToString());
			Assert.AreEqual("1 row, 1 column",
			                new GridDimensions(1, 1).ToString());
			Assert.AreEqual("5 rows, 1 column",
			                new GridDimensions(5, 1).ToString());
			Assert.AreEqual("1 row, 66 columns",
