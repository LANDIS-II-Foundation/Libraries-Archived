...
namespace Landis.Test
{
	...
	public class Landscape_Test
	{
		...
		{
			uint inactiveDataIndex;
			if (landscape.ActiveSiteCount == landscape.Count)
				inactiveDataIndex = landscape.ActiveSiteCount;
			else
				inactiveDataIndex = landscape.ActiveSiteCount + 1;
