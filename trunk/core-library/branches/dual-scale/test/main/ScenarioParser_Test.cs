...
namespace Landis.Test.Main
{
    ...
    public class ScenarioParser_Test
    {
        ...
        [Test]
        [ExpectedException(typeof(LineReaderException))]
        public void DualScale_WrongName()
        {
            TryParse("DualScale-WrongName.txt", 14);
        }
        ...
        [Test]
        [ExpectedException(typeof(LineReaderException))]
        public void DualScale_MissingValue()
        {
            TryParse("DualScale-MissingValue.txt", 13);
        }
        ...
        [Test]
        [ExpectedException(typeof(LineReaderException))]
        public void DualScale_BadValue()
        {
            TryParse("DualScale-BadValue.txt", 14);
        }
        ...
        [Test]
        [ExpectedException(typeof(LineReaderException))]
        public void DualScale_Zero()
        {
            TryParse("DualScale-Zero.txt", 13);
        }
        ...
        [Test]
        [ExpectedException(typeof(LineReaderException))]
        public void DualScale_Negative()
        {
            TryParse("DualScale-Negative.txt", 14);
        }
        ...
        [Test]
        [ExpectedException(typeof(LineReaderException))]
        public void DualScale_Extra()
        {
            TryParse("DualScale-Extra.txt", 14);
        }
